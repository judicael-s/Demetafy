...
| WB-04 | Home | Instagram | populated | Light | ≈1280×800 | Mouse | Resolved: Home now states local processing and names downloads plus Instagram avatar fetching as user-initiated network actions. | launch-blocker | Source-reviewed Task 4 route polish; native recheck remains with root. | Resolved by Task 4 route polish | Recheck the disclosure in the final native matrix. |
...
| WB-30 | Settings / network disclosure | Instagram | populated | Light + Dark | ≈1280×800 | Mouse + keyboard | Resolved: Settings distinguishes user-started media downloads from the separate opt-in Instagram avatar fetch without claiming either is the only network feature. | launch-blocker | Source-reviewed Task 4 route polish; native recheck remains with root. | Resolved by Task 4 route polish | Recheck disclosure order and keyboard reading in the final native matrix. |
